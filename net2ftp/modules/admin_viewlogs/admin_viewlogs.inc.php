...
// Query 3
	...
	$table3 = printTable($mydb, $sqlquery3);
	if ($net2ftp_result["success"] == false) { return false; }
...
// Query 4
	...
	$table4 = printTable($mydb, $sqlquery4);
	if ($net2ftp_result["success"] == false) { return false; }
...
function printTable($mydb, $sqlquery) {
